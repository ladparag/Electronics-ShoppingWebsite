...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <div class="center_content">
     ...
     <h2><span style="color: #003300"><font color="red"><blink> WELCOME ! <%=userName %></blink></span></h2>
<h2><marquee><mark><span style="color: red"><font color="red">YOUR REQUEST HAS COMPLETED..!!!!!! </span></mark></marquee></h2>
      
      
    </div>
    <!-- end of center content -->
    <div class="right_content">
    	<div class="title_box"><h2><mark><blink>Login</blink></mark></h2></div>
      <div class="border_box">

...
.style9 {font-size: 12px; font-weight: bold; color: #003300; font-family: Verdana, Arial, Helvetica, sans-serif; }
...
<div id="main_container">
  ...
  <div id="main_content">
   ...
   <form action="../CustomerAddrServlet" method="get"></form>    
     <h2><span style="color:#003300"><center> Welcome Administrator </center></span></h2>
    <p align="justify" class="style9">Shipping Address Detail</p><br/>
    
    <table width="100%" border="0">          
      </tr>
      
     <%List list=(List)session.getAttribute("ab");

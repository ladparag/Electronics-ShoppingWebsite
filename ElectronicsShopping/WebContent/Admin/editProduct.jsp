...
function validate()
{
	...
	var catId= document.editForm.catId.value;
	var itemName= document.editForm.itemName.value;
	var catName= document.editForm.catName.value;
	var description= document.editForm.description.value;
	var price= document.editForm.price.value;
	var stocks=document.editForm.stocks.value;
  ...
  <div id="main_content">
    ...
    <div class="left_content">
      ...
      <ul class="left_menu">
        ...
        <li class="odd" ><a href="../ProductViewEditDeleteServlet?action=getProductByCategory&catName=${cat.catName}">${cat.catName}</a></li>
    ...
    <div class="center_content">
      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
         ...
         <form name="editForm" action="../ProductViewEditDeleteServlet"  method="post"   onsubmit="return validate()"> 
...
<td><input type="text" class="customtxtbox"   name="itemId" id="itemId" value="${product.itemId }"><br>
</td>
</tr>
<tr>
<td class="tbheading">
...
<td><input class="customtxtbox"  type="text" name="catId" id="catId" value="${product.catId }"><br>
</td>
</tr>
<tr>
<td class="tbheading">
...
<td><input class="customtxtbox"  type="text" name="itemName" id="itemName" value="${product.itemName }"><br>
</td>
</tr>
...
<td class="tbheading">Category
 ...
 <!--<input class="customtxtbox" type="text" name="catName" id="catName"><br> -->
</td>
</tr>
<tr>
<td class="tbheading">Description
</td>
<td> <textarea name="description" id="description" rows="4" cols="25" value="${product.description}">
<c:out value="${product.description}" />
</textarea><!-- <input class="customtxtbox"  type="text" name="description" id="description"> --><br>
</td>
</tr>
<tr>
<td class="tbheading">
...
<td><input class="customtxtbox" type="text" name="price" id="price" value="${product.price }"><br>
</td>
</tr>
<%-- <tr>
...
<td><input class="customtxtbox" type="text" name="total" id="total" value="${product.total }"><br>
</td>
</tr> --%>
<tr>
<td class="tbheading">
...
<td><input class="customtxtbox" type="text" name="stocks" id="stocks" value="${product.stocks }"><br>
</td>
</tr>
<tr>
<td class="tbheading">
...
<td><input class="customtxtbox" type="file" name="image" id="image" value="${product.image }"><br>
</td>
</tr>
<tr>

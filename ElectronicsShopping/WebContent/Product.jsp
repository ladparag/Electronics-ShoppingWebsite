<%@ page language="java"  import="java.util.*,com.electronicshop.pojo.*"  contentType="text/html; charset=ISO-8859-1"
...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    %>
        <tr>
        	<td><%=p.getItemId() %></td>
          <td><%=p.getItemName() %><br/> <a href="ProductViewEditDeleteServlet?action=ViewProductDetails&itemId=<%=p.getItemId() %>" class="prod_details">details</a> </div>
                    </td>

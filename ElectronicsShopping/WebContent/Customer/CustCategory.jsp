 ...
 <td bordercolor="#669933" bgcolor="#006666"><span class="style10">Cart</span></td><strong></strong>      </tr>
    ...
    %>
        <tr>
          ...
          <td><img src="<%=p.getImage() %>" height="130px" width="125px"/></a></td>
          <td><%=p.getPrice() %></td>
           <td><a href="../InsertCartServlet?itemId=<%=p.getItemId() %>"><img src="images/shopping-cart.png"/></a></td>

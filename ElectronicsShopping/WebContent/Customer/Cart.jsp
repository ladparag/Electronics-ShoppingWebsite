...
<table width="100%" border="1" bordercolor="#003300">
	<tr>
		...
		<td bgcolor="#006666" class="style10 style3"><strong>Image</strong></td>
		<td bgcolor="#006666" class="style10 style3"><strong>Delete/cancel</strong></td>
	</tr>
...
%>
	<tr>
		...
		<td class="style3">
		<div align="left" class="style9 style5"><strong><%=k.getCartId() %></strong></div>
		</td>
		<td class="style3">
		...
		<td class="style3"><img src="<%=k.getImage() %>"
			alt="" width="124" height="140" border="5" /></td>
		<td class="style3"><a
			href="../DeleteCartServlet?cartId=<%=k.getCartId() %>"><img
...
<tr>
<center>
<!--  <a href="../AllProductCustomerServlet"><input type="submit" value="Continue Shoping"/></a> -->
</center>
</tr>

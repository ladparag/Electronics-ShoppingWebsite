...
<head>
<title>Customer Electronix Store</title>
...
<div id="main_container">
 ...
 <form action="../ProductServletCustomer" method="get"></form>
    ...
    <table width="100%" border="1" cellpadding="2" cellspacing="2" bordercolor="#669933">
      <tr>
      <td bordercolor="#669933" bgcolor="#006666"><span class="style10">Code</span></td>
        ...
        <td bordercolor="#669933" bgcolor="#006666"><span class="style10">Cart</span></td><strong></strong>      </tr>
      
      <%List list=(List)session.getAttribute("p");
      ...
      %>
        ...
        <tr>
         <td><%=p.getItemId() %></td>
          ...
          <td><a href="../InsertCartServlet?itemId=<%=p.getItemId() %>"><img src="<%=p.getImage() %>" height="130px" width="125px"/></a></td>
          
          <td><%=p.getPrice() %></td>
          
         
           <td><a href="../InsertCartServlet?itemId=<%=p.getItemId() %>"><img src="images/shopping-cart.png"/></a></td><strong></strong>        </tr>

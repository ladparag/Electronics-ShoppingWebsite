...
<p align="justify" style="font-size:15px;"><span class="style8">W</span>elcome to Online  Shopping website. Here you can buy various Electronics products such as
Mobiles Phones,Television,Tablets,Computers,Laptops etc of various well known brands.
Customer has to just register on this website and then he or she can buy
various Electronics products online. You need not to go to shopping mall.</p><br></br>
<p align="justify" style="font-size:15px;">We provide best quality of Electronics Products. If you
have any complain regarding dispatched order feel free to send us
feedback. So we can improve our services.</p><br></br>
...
<input type="radio" name="rdType" value="Admin" id="rdType_0" />Admin</label> <br>
<label style="font-size:14px;font-weight:bold;"> 
<input type="radio" name="rdType" value="Customer" id="rdType_1" checked="checked" /> Customer</label> <br>

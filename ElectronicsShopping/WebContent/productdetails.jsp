...
%>  
      ...
      <table border="1px" bordercolor="#008080" cellpadding="10"width="550px" height="50px" align="center">
      <tr><td><p class="product_title_big">Product Id:</p><span class="product_title_big" >${product.itemId}</span>&nbsp;<span class="product_title_big">${product.itemName}</span>
      </td></tr>
      <tr><table border="1px" bordercolor="#008080" cellpadding="20" width="550px" height="400px" align="center" >
      <tr>
      <td width="250px" ><img src="${product.image }" alt="0" height="370px" width="250px"/>
      </td>
      <td><h1 class=" specifications">Description</h1> <span class="blue" style="font-size:12px;">${product.description }</span><br/><br/>
      
      <b>Category:</b> <span class="blue" style="font-size:12px;">${product.catName }</span><br/><br/>
      <b>Price:</b> <span class="price" style="font-size:12px;">${product.price}</span><br/><br/>
    <%--     <a href="ProductServlet?action=AddToCart&prodId=${product.prodId}" class="addtocart" style="font-size:12px;">Add to cart</a>
        --%>     
      </td></tr>
      </table>
      </tr>

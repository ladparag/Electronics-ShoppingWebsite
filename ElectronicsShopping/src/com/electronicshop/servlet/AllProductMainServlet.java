...
/**
 * Servlet implementation class AllProductMainServlet
 */
@WebServlet("/AllProductMainServlet")
public class AllProductMainServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AllProductMainServlet() {
        super();
